...
<script type="text/javascript">
  ...
  function equipmentDelete(id) {
	  if (confirm("确定要删除这条记录吗？")) {
		  $.post(
			"${pageContext.request.contextPath}/equipment/delete.do",
			{id: id},
			function(result) {
...
<div class="row search">
  ...
  <div class="col-md-6">
    <button type="button" class="btn btn-primary" style="float: right;" 
            onclick="javascript:window.location.href='${pageContext.request.contextPath}/equipment/preSave.do'">
           添加
    </button>
  </div>
</div>
    ...
    <c:forEach var="equipment" items="${equipmentList }" varStatus="status">
      <tr>
        ...
        <td>
          ...
          onclick="javascript:window.location.href='${pageContext.request.contextPath }/equipment/preSave.do?id=${equipment.id }'">
          	修改
          </button>
