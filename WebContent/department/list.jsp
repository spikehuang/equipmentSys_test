...
<script type="text/javascript">
  ...
  function departmentDelete(id) {
	  if (confirm("确定要删除这条记录吗？")) {
		  $.post(
			"${pageContext.request.contextPath}/department/delete.do",
			{id: id},
			function(result) {
...
<div class="row search">
  ...
  <div class="col-md-6">
    <button type="button" class="btn btn-primary" style="float: right;" 
            onclick="javascript:window.location.href='${pageContext.request.contextPath}/department/preSave.do'">
           添加
    </button>
  </div>
</div>
    ...
    <c:forEach var="department" items="${departmentList }" varStatus="status">
      <tr>
        ...
        <td>
          ...
          onclick="javascript:window.location.href='${pageContext.request.contextPath }/department/preSave.do?id=${department.id }'">
          	修改
          </button>
